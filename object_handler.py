...
class ObjectHandler:
    def __init__(self, game):
        ...
        self.sprite_list = []
        self.npc_list = []
        self.npc_sprite_path = 'doom/DOOM-style-Game-main/resources/sprites/npc'
        self.static_sprite_path = 'doom/DOOM-style-Game-main/resources/sprites/static_sprites/'
        self.anim_sprite_path = 'doom/DOOM-style-Game-main/resources/sprites/animated_sprites/'
